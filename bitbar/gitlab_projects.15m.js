...
var private_token = process.env.GITLAB_PRIVATE_TOKEN;
var default_page  = '/pipelines';
var order_by      = 'last_activity_at';
var font_size     = '15';

var options = {
  host: gitlab_domain,
  path: '/api/v4/projects?visibility=private&order_by=' + order_by + '&sort=desc',
...
var request_callback = function(res) {
  ...
  res.on('end', function () {
    ...
    for(var p in projects) {
      ...
      var ta = timeago();
      var name = P.name_with_namespace;
